...
from exceptions import ApiServiceError, JSONDecodeError
from coordinates import Coordinates, get_city_coordinates
import config
...
def _parse_weather_type(openweather_dict: dict):
    try:
...
if __name__ == "__main__":
    ...
    сoordinates = get_city_coordinates(city=city_name)

    print(get_weather(сoordinates))